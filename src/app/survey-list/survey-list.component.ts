...
export class SurveyListComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['id', 'Name', 'Category', 'Publishing Date', 'Ending Date', 'Created By'];
  ...
  public async getSurveys() {
    this.error = "";
    await this.ras.callApi('http://localhost:8080/surveyspring/api/surveys', 'GET', '')
      .then((res) => {
    ...
    await this.ras.callApi('http://localhost:8080/surveyspring/api/users/' + this.mail, 'GET', '')
      .then((res) => {
